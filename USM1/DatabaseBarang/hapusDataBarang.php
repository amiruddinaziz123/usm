...
<head>
    ...
    <title>USM | FTIK | Hapus Data Barang</title>
...
<body>
    ...
    <center>
        <div id="fromulir">
            ...
            <h6>Masukkan nama barang yang ingin dihapus. <br><br> (peringatan) <br><br> <strong style="color: red;">Ini
                    akan
                    menghapus 1
                    baris
                    dari
                    nama barang yang anda masukkan
                </strong>
            </h6>
            <form action="prosesHapusDataBarang.php" method="post" onsubmit="return validateForm()">
                <div class="mb-4 row">
